...
const certs = [
  {
    title: 'BS EN ISO 1461:2009',
    desc: 'Tiêu chuẩn mạ kẽm nhúng nóng quốc tế',
  },
  {
    title: 'ASTM A123 / JIS H8641',
    desc: 'Tiêu chuẩn Mỹ và Nhật Bản',
  },
  {
    title: 'ISO 9001:2008',
    desc: 'Hệ thống quản lý chất lượng – Vinacontrol',
  },
  {
    title: 'AGA Member 2016',
    desc: 'Thành viên Hiệp hội Mạ Kẽm Hoa Kỳ',
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Công ty Cổ phần Kỹ thuật Công nghệ Quang Minh
            </h2>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-3 text-sm text-gray-600">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="font-semibold text-gray-800">Nhà máy:</span> Lô CN09, KCN Nguyên Khê, Đông Anh, Hà Nội
                </div>
              </div>
            </div>
          </div>
