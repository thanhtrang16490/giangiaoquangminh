...
const products = [
  // --- HỆ CHỐNG ---
  {
    id: 1,
    category: 'chong',
    name: 'Thanh Chống Đứng – Hệ Chống',
    code: 'ZV-25 / ZV-20 / ZV-15 / ZV-10',
    spec: 'Ø48.3 × 3.2 mm',
    details: [
  ...
  },
  {
    id: 2,
    category: 'chong',
    name: 'Giằng Ngang – Hệ Chống',
    code: 'ZH-12 / ZH-09 / ZH-06',
    spec: 'Ø48.3 × 2.5 mm',
    details: [
  ...
  },
  {
    id: 3,
    category: 'chong',
    name: 'Giằng Chéo – Hệ Chống',
    code: 'ZB-1215 / ZB-0915 / ZB-0615',
    spec: 'Ø33 × 2.3–2.5 mm',
    details: [
  ...
  // --- HỆ BAO CHE ---
  {
    id: 4,
    category: 'baoche',
    name: 'Thanh Chống Đứng – Hệ Bao Che',
    code: 'ZV-18B / ZV-15B / ZV-12B / ZV-09B',
    spec: 'Ø42.2 × 2.5 mm',
    details: [
  ...
  },
  {
    id: 5,
    category: 'baoche',
    name: 'Giằng Ngang – Hệ Bao Che',
    code: 'ZH-18B đến ZH-06B',
    spec: 'Ø42.2 × 2.5 mm',
    details: [
  ...
  },
  {
    id: 6,
    category: 'baoche',
    name: 'Giằng Chéo – Hệ Bao Che',
    code: 'ZX-18 / ZX-15 / ZX-12 / ZX-09 / ZX-06',
    spec: 'Ø21.2×2 / Ø27×2 mm',
    details: [
  ...
  // --- PHỤ KIỆN ---
  {
    ...
    category: 'phukien',
    name: 'Thép Hộp (Xà Gồ)',
    code: 'ZAKXG50 / ZAKXG100',
    spec: 'Tiết diện 50 mm & 100 mm',
    details: [
  ...
  },
  {
    id: 8,
    category: 'phukien',
    name: 'Kích Chân (Base Jack)',
    code: 'Base Jack',
    spec: 'Ren Ø38 mm, đế 150 mm',
    details: [
      { code: 'Base Jack', length: 'Điều chỉnh được', weight: '—' },
    ],
  ...
  },
  {
    id: 9,
    category: 'phukien',
    name: 'Kích Đầu (U-Head Jack)',
    code: 'U-Head Jack',
    spec: 'Đầu U 140 mm, ren Ø60 mm',
    details: [
      { code: 'U-Head Jack', length: 'Điều chỉnh được', weight: '—' },
    ],
          ...
          {filtered.map(product => (
            ...
            >
              ...
              <div className="px-6 pb-5">
                <a
                  href="#contact"
                  className="block text-center py-2.5 bg-gray-900 text-white text-sm font-semibold rounded-lg hover:bg-red-600 transition-colors duration-300"
                >
                  Yêu Cầu Báo Giá
                </a>
              </div>
