...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    'Sản Phẩm': [
      { label: 'Giàn Giáo Ringlock', href: '#solutions' },
      { label: 'Xà Gồ Thép', href: '#solutions' },
      { label: 'Giàn Giáo Sự Kiện', href: '#solutions' },
      { label: 'Phụ Kiện & Linh Kiện', href: '#solutions' }
    ],
    'Dự Án': [
      { label: 'Xây Dựng', href: '#projects' },
      { label: 'Công Nghiệp', href: '#projects' },
      { label: 'Hạ Tầng', href: '#projects' },
      { label: 'Sự Kiện', href: '#projects' }
    ],
    'Hỗ Trợ': [
      { label: 'Hướng Dẫn An Toàn', href: '#' },
      { label: 'Thông Số Kỹ Thuật', href: '#' },
      { label: 'Tài Liệu Lắp Dựng', href: '#' },
          ...
          <div className="lg:col-span-2">
            <div className="mb-5">
              <a href="/" className="flex items-center">
                <img src="/quang-minh-logo.svg" alt="Quang Minh Technology Engineering" className="h-10 w-auto brightness-0 invert" />
              </a>
            </div>
            ...
            <div className="mb-6">
              ...
              <form onSubmit={handleSubscribe} className="flex">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-gray-800 text-white rounded-l-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-sm"
                  required
                />
                <button
                  type="submit"
                  className="px-5 py-3 bg-red-600 text-white font-semibold rounded-r-lg hover:bg-red-700 transition-colors text-sm"
                >
                  Đăng Ký
                </button>
              </form>
              {isSubscribed && (
                <p className="mt-2 text-green-400 text-xs">Đăng ký thành công!</p>
              )}
            </div>
          </div>
